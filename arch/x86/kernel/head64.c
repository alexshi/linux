...
again:
	...
	if (!pgtable_l5_enabled())
		...
		p4d_p = (pmdval_t *)((pgd & PTE_PFN_MASK) + __START_KERNEL_map - phys_base);
	else {
		...
		p4d_p = (pmdval_t *)early_dynamic_pgts[next_early_pgt++];
	...
	if (p4d)
		...
		*p4d_p = (pmdval_t)pud_p - __START_KERNEL_map + phys_base + _KERNPG_TABLE;
	}
